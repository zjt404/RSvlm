...
SFT_ADAPTER="${SFT_ADAPTER:-${PROJECT_ROOT}/outputs/sft_context_v4_stage2/v0-20260904-162507/checkpoint-1412}"
TRAIN_DATA="${TRAIN_DATA:-${PROJECT_ROOT}/data/processed_context_v4_stage2_mixed/grpo_dense_train.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/grpo_dense_context}"
